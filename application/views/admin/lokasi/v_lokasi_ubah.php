                      ...
                      <div class="card-body">
                        <div class="form-group row mb-4">
                          ...
                          <div class="col-sm-12 col-md-7">
                            ...
                            <input type="text" name="nama" class="form-control" placeholder="Masukan Nama Toko" value="<?php echo $a->nama_lokasi; ?>" required>
                        ...
                        <div class="form-group row mb-4">
                          ...
                          <div class="col-sm-12 col-md-7">
                            <input type="text" name="kode" class="form-control" placeholder="Masukan Kode Nama Toko" value="<?php echo $a->kode_lokasi; ?>" required>
